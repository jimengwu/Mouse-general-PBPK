...
## input PBPK model
mousePBPK.code     <- readRDS (file = "micePBPK.RDS")
...
# Create the matrix 
# nrow is the number of rows or the number of hours. 298 days, 
# the first exposure is on day 0. So 297*24+ the title row and the 0 time point row. 
MC.rat.a.CA    = matrix(nrow = nrwo.r, ncol = 5000) 
